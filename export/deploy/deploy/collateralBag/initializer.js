    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          (_a = (0, utils_1.getNetworkConfig)({ network: network })),
            (coreParams = _a.coreParams),
            (settlementParams = _a.settlementParams),
            (feeParams = _a.feeParams),
            (ctParams = _a.ctParams),
            (mocAddresses = _a.mocAddresses);
        ...
        case 1:
          ...
          mocCARC20 = typechain_1.MocCARC20__factory.connect(deployedMocContract.address, signer);
        ...
        case 2:
          ...
          CollateralToken = typechain_1.MocTC__factory.connect(deployedTCContract.address, signer);
        ...
        case 3:
          ...
          MocCAWrapper = typechain_1.MocCAWrapper__factory.connect(deployedMocCAWrapperContract.address, signer);
        ...
        case 4:
          ...
          WCAToken = typechain_1.MocRC20__factory.connect(deployedWCAContract.address, signer);
          (governorAddress = mocAddresses.governorAddress),
        ...
        case 7:
          ...
          return [
            4 /*yield*/,
            (0, utils_1.waitForTxConfirmation)(
