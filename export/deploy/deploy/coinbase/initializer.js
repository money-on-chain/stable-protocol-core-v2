    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          MocCACoinbase = typechain_1.MocCACoinbase__factory.connect(deployedMocContractProxy.address, signer);
        ...
        case 2:
          ...
          if (!(network == "hardhat")) return [3 /*break*/, 5];
